...
public class TestPlayground extends SimpleApplication implements PlaygroundConstant {
  ...
  public void simpleInitApp() {
    ...
    board.attachChild(SkyFactory.createSky(getAssetManager(), "Textures/Sky/Bright/BrightSky.dds", SkyFactory.EnvMapType.CubeMap));
    //System.out.println(otherGoal.getChild("trans").getLocalTranslation());
    //System.out.println(goal.getChild("trans").getLocalTranslation());
